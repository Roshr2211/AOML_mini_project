...
class ImplicitSDFgeom(BaseImplicitGeometry):
    @dataclass
    ...
    def create_from(
        ...
        **kwargs,
        ...
        if isinstance(other, ImplicitSDFgeom):
            instance = ImplicitSDFgeom(cfg, **kwargs)
            ...
            raise TypeError(
                f"Cannot create {ImplicitSDFgeomgeom.__name__} from {other.__class__.__name__}"
            )

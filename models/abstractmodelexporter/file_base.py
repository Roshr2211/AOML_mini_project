...
class BaseExporter(BaseObject):
    ...
    def __call__(self, *args, **kwargs) -> List[BaseExporterOutput]:
        raise NotImplementedError


@threestudio.register("dummy-exporter")
class DummyBaseExporter(BaseExporter):
    def __call__(self, *args, **kwargs) -> List[BaseExporterOutput]:
        # DummyBaseExporter does not export anything
        return []

...
from threestudio.models.exporters.base import BaseExporter, BaseExporterOutput
...
class MeshBaseExporter(BaseExporter):
    @dataclass
    class Config(BaseExporter.Config):
    ...
    def __call__(self) -> List[BaseExporterOutput]:
    ...
    def export_obj_with_mtl(self, mesh: Mesh) -> List[BaseExporterOutput]:
        params = {
            "mesh": mesh,
            "save_mat": True,
    ...
    def export_obj(self, mesh: Mesh) -> List[BaseExporterOutput]:
        params = {
            "mesh": mesh,
            "save_mat": False,
            "save_normal": self.cfg.save_normal,
